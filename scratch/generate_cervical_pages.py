...
# Configuration
source_dir = 'back-pain-treatment'
target_dir = 'cervical-spine-surgery'

def replicate_structure():
    print(f"Starting detailed replication from {source_dir} to {target_dir}...")
    ...
    for root, dirs, files in os.walk(source_dir):
        ...
        if 'index.php' in files:
            ...
            # rel_path "haryana" -> count 0 -> depth 2 -> "../../"
            # rel_path "haryana/gurgaon" -> count 1 -> depth 3 -> "../../../"
            ...
            with open(target_file, 'w') as f:
                ...
                f.write(f'include __DIR__ . "/{levels}includes/master-cervical-template.php";\n')
                f.write("?>")

if __name__ == "__main__":
    replicate_structure()
    print("Clean replication complete!")

...
?>
  ...
  <section class="hero">
    <div class="container">
      <div class="hero-content">
        <h1 class="fade-in-up">Best Neurosurgeon in India – <br><span class="text-gradient">Dr. Arun Saroha</span></h1>
        <p class="hero-tagline fade-in-up">Restoring Lives with Precision & Care</p>
        <p class="hero-subtext fade-in-up delay-1">Consult the <strong>best neurosurgeon in India</strong>. Experience state-of-the-art medical and surgical care for brain and spine conditions, backed by decades of trusted expertise.</p>
        <div class="hero-buttons fade-in-up delay-2">
          <a href="#contact" class="btn btn-primary btn-large">Get Appointment</a>
          <a href="#services" class="btn btn-white btn-large">Explore Procedures</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="about" class="about-section">
    <div class="container about-container">
      <div class="about-image-wrapper">
        ...
        <img src="assets/images/dr_portrait.png" alt="Dr. Arun Saroha – Best Neurosurgeon in India at Max Hospital Delhi" class="about-img">
      </div>
      <div class="about-text">
        <span class="badge">About The Doctor</span>
        <h2>Best Neurosurgeon & Spine Surgeon in India</h2>
        <p>Dr. Arun Saroha is widely regarded as the best neurosurgeon in India, serving as a premier Brain & Spine Surgeon at Max Hospital, India. With over 25 years of experience and 8,000+ successful surgeries, he specialises in highly complex brain and spine procedures, bringing precision, empathy, and advanced technology to every patient. As a leading neurosurgeon in Delhi and Gurugram, Dr. Saroha offers world-class neurological care to patients from across India and internationally.</p>

        <ul class="features-list">
          <li><strong>Education:</strong> MBBS & MS from RNT Medical College, MCh (Neurosurgery) from PGI Chandigarh.</li>
          <li><strong>24/7 Emergency:</strong> Offering the most advanced treatment of the brain and spine unconditionally.</li>
          <li><strong>Modern Technology:</strong> Utilizing cutting-edge minimally invasive techniques and equipment.</li>
        </ul>

        <a href="about.php" class="btn btn-secondary mt-2">Read Full Profile</a>
      </div>
    </div>
  </section>
  ...
  <section id="services" class="services-section bg-light">
    <div class="container">
      <div class="section-title text-center">
        <span class="badge">Our Specialties</span>
        <h2>Advanced Brain & Spine Procedures by India's Best Neurosurgeon</h2>
        <p>World-class medical interventions utilizing minimally invasive techniques.</p>
      </div>
      ...
      <div class="services-grid mt-4">
        ...
        <div class="service-card">
          ...
          <p>Back pain significantly impacts the lives of millions. Dr. Arun Saroha emerges as a prominent figure in combating this pervasive issue with advanced clinical protocols.</p>
          <a href="herniated-disc/" class="service-link">View Department <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Advanced procedures designed to address conditions affecting the neck portion of the spine, relieving pressure on the spinal cord or nerves.</p>
          <a href="cervical-spondylosis/" class="service-link">View Department <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Treating discs that wear down and cause pain. As the best neurosurgeon in Delhi, Dr. Saroha provides advanced non-surgical and surgical solutions.</p>
        ...
        <div class="service-card">
          ...
          <p>Expert removal of abnormal cell growths in the brain. Dr. Saroha is recognized as the best neurosurgeon in the world for complex oncology.</p>
          <a href="brain-surgery/" class="service-link">View Department <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Managing weak spots on brain blood vessels. Consult the best neurosurgeon in Delhi for advanced clipping and coiling techniques.</p>
          <a href="#contact" class="service-link">Read More <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Stop routine discomfort from disrupting your life. Comprehensive neurological diagnostics and long-term relief protocols.</p>
          <a href="#contact" class="service-link">Read More <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Using advanced techniques with smaller incisions, resulting in less tissue damage and significantly faster recovery times.</p>
          <a href="#contact" class="service-link">Read More <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Artificial disc replacement preserves natural spinal motion. Utilizing the latest prosthetic technology for superior mobility outcomes.</p>
          <a href="#contact" class="service-link">Read More <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <h3>Scoliosis & Deformity Correction</h3>
          <p>Complex deformity correction using navigation-guided instrumentation and intraoperative neuromonitoring for maximum patient safety.</p>
          <a href="#contact" class="service-link">Read More <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Relieving nerve compression caused by narrowing of the spinal canal. Expert decompression techniques for pain-free walking.</p>
          <a href="#contact" class="service-link">Read More <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Managing excess brain fluid through VP shunt placement and endoscopic ETV for both pediatric and adult patients.</p>
          <a href="#contact" class="service-link">Read More <span>&rarr;</span></a>
        </div>
        ...
        <div class="service-card">
          ...
          <p>Ultra-minimally invasive surgery with incisions as small as 8mm, enabling rapid recovery and minimal hospital stay.</p>
          <a href="#contact" class="service-link">Read More <span>&rarr;</span></a>
        </div>
      </div>
    </div>
  ...
  <section id="awards" class="awards-section">
    <div class="container">
      <div class="section-title text-center">
        <span class="badge">Awards & Recognition</span>
        <h2>Trusted by Patients, Recognised by Peers</h2>
  ...
  <section id="why-choose" class="why-choose-section bg-light">
    <div class="container">
      <div class="section-title text-center">
        ...
        <h2>Why Patients Choose India's Best Neurosurgeon</h2>
      </div>
      <div class="why-grid mt-4">
        ...
        <div class="why-card">
          ...
          <p>Advanced keyhole and endoscopic surgeries that mean smaller incisions, less pain, and faster recovery.</p>
        </div>
        <div class="why-card">
        ...
        <div class="why-card">
          ...
          <p>Dedicated coordination for overseas patients including visa assistance, airport pickup, translation, and post-op follow-up.</p>
        </div>
        <div class="why-card">
          <div class="why-number">05</div>
          <h3>24/7 Emergency Care</h3>
          <p>Round-the-clock availability for emergency brain and spine surgeries with rapid response protocols.</p>
        </div>
        <div class="why-card">
          <div class="why-number">06</div>
          <h3>Personalised Treatment Plans</h3>
          <p>Every patient receives a customised care plan tailored to their specific condition, age, and recovery goals.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="testimonials-grid mt-4">
        <div class="testimonial-card">
          ...
          <p class="testimonial-text">"Dr. Arun Saroha performed my mother's brain tumor surgery at Max Hospital Gurugram. The precision and care were extraordinary. She recovered much faster than we expected. Truly the best neurosurgeon in India."</p>
          <div class="testimonial-author">
            <strong>Rajesh Kumar</strong>
            <span>Brain Tumor Surgery, Delhi</span>
          </div>
        </div>
        <div class="testimonial-card">
          <div class="testimonial-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
          <p class="testimonial-text">"I travelled from Nigeria for my spine surgery. Dr. Saroha and his team made the entire process seamless — from visa support to post-operative care. I'm walking pain-free after years of suffering."</p>
          <div class="testimonial-author">
            <strong>Adebayo Ogunlesi</strong>
            <span>Spine Surgery, International Patient</span>
          </div>
        </div>
        <div class="testimonial-card">
          <div class="testimonial-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
          <p class="testimonial-text">"After consulting three other surgeons, Dr. Saroha was the only one confident enough to take on my complex cervical spondylosis case. The minimally invasive approach meant I was back at work in three weeks."</p>
          <div class="testimonial-author">
            <strong>Priya Sharma</strong>
            <span>Cervical Spine Surgery, Gurugram</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="patients" class="international-section bg-light">
    <div class="container">
      <div class="international-container">
        <div class="international-text">
          <span class="badge">International Patients</span>
          <h2>World-Class Neurosurgery for Global Patients</h2>
          <p>Dr. Arun Saroha has successfully treated patients from over 30 countries. Our dedicated international patient desk provides end-to-end support to make your medical journey to India smooth and stress-free.</p>
          <ul class="features-list">
            <li><strong>Visa Assistance:</strong> Medical visa invitation letter and documentation support.</li>
            <li><strong>Airport Transfers:</strong> Complimentary pickup and drop for international patients.</li>
            <li><strong>Language Support:</strong> Translators available for Arabic, French, Russian, and Swahili.</li>
            <li><strong>Tele-Consultation:</strong> Video consultations before you travel so you arrive with a clear treatment plan.</li>
            <li><strong>Post-Op Follow-Up:</strong> Remote follow-up consultations after you return home.</li>
          </ul>
          <a href="#contact" class="btn btn-primary mt-2">Request International Consultation</a>
        </div>
  ...
  <!-- Transformative Care CTA -->
  <section class="mega-cta">
    <div class="container text-center">
      <h2>Consult India's Best Neurosurgeon – Expert Brain & Spine Care</h2>
      <p>Whether you need emergency intervention or a second opinion, we're here to guide you to recovery.</p>
      <a href="#contact" class="btn btn-white btn-large">Schedule a Consultation</a>
    </div>
  </section>
  ...
  <section id="faq" class="faq-section">
    <div class="container">
      <div class="section-title text-center">
        ...
        <h2>Frequently Asked Questions – Best Neurosurgeon in India</h2>
      </div>
      <div class="faq-grid mt-4">
        <div class="faq-item">
          <h3>Who is the best neurosurgeon in India?</h3>
          <p>Dr. Arun Saroha is widely regarded as the best neurosurgeon in India, with 25+ years of experience and over 8,000 successful brain and spine surgeries at Max Hospital, Delhi and Gurugram.</p>
        </div>
        <div class="faq-item">
          <h3>What conditions does Dr. Arun Saroha treat?</h3>
          <p>He treats brain tumors, disc herniation, cervical spondylosis, deep brain stimulation, neurological disorders, spinal cord conditions, and more using minimally invasive techniques.</p>
        </div>
        <div class="faq-item">
          <h3>Where is Dr. Arun Saroha based?</h3>
          <p>Dr. Saroha practices at Max Hospital Gurugram and Max Super Speciality Hospital Saket, New Delhi. He also consults international patients online.</p>
        </div>
        <div class="faq-item">
          <h3>How do I book an appointment?</h3>
          <p>Call +91 98187 78811 or use the Book Consult form on this page. Emergency consultations are available 24/7.</p>
        </div>
        <div class="faq-item">
          <h3>What is minimally invasive spine surgery?</h3>
          <p>Minimally Invasive Spine Surgery (MISS) uses small incisions (8–15mm) with advanced navigation and microsurgical tools, resulting in less pain, minimal scarring, faster recovery, and reduced hospital stay compared to traditional open surgery.</p>
        </div>
        <div class="faq-item">
          <h3>Does Dr. Saroha treat international patients?</h3>
          <p>Yes. Dr. Saroha has treated patients from over 30 countries. His dedicated international patient desk provides medical visa support, airport transfers, language interpreters, and post-operative remote follow-ups.</p>
        </div>
        <div class="faq-item">
          <h3>What is the success rate for brain tumor surgery?</h3>
          <p>Using neuronavigation and intraoperative monitoring, Dr. Saroha achieves maximum tumor resection with nerve preservation. Success depends on tumor type, size, and location — your case will be evaluated individually during consultation.</p>
        </div>
        <div class="faq-item">
          <h3>How much does a consultation cost?</h3>
          <p>Consultation fees vary by appointment type. Priority and international consultations can be arranged via phone (+91 98187 78811) or WhatsApp. Submit the form on this page and our team will respond within 24 hours.</p>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="contact-form-wrapper">
          <form class="contact-form" accept-charset='UTF-8' action='https://app.formester.com/forms/8b968eed-e587-4ac1-9b4a-0c508b75c1cc/submissions' method='POST'>
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                <label for="condition">Condition / Query</label>
            ...
            <div class="form-group">
              ...
              <textarea id="message" name="message" rows="4" placeholder="Briefly describe your condition or query"></textarea>
            </div>
            <button type="submit" class="btn btn-primary btn-large">Submit Consultation Request</button>
          </form>
        </div>
      </div>
    </div>
